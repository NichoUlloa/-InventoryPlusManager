...
public class VentanaRegistrarCategoria extends Ventana {
    ...
    private void generarCampoNombreCategoria() {
        ...
        super.generarJLabel(this.textoNombreCategoria, textoNombreCategoria, 20, 80, 150, 30);
        campoNombreCategoria = super.generarJTextField(200, 80, 250, 30);
        this.add(campoNombreCategoria);
    }

    private void generarBotonRegistrar() {
        String textoBoton = "Registrar Categoria";
        botonRegistrar = super.generarBoton(textoBoton, 55, 400, 170, 40);
    ...
    private void generarBotonCancelar() {
        ...
        botonCancelar = super.generarBoton(textoBotonCancelar, 275, 400, 170, 40);
